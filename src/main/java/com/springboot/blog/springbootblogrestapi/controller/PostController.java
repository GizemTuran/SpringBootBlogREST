...
public class PostController {
    ...
    @PreAuthorize("hasRole('ADMIN')") // bir methodun çağırılabilirliğini hangi rol tarafından izin verildiğini belirler
    @PostMapping
    ...
    @Operation(
            ...
            description = "Get Post By Id REST API is used to single post from the database"
    )
    @ApiResponse(
            responseCode = "200",
            description = "Http Status 200 SUCCESS"
